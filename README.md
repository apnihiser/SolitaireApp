...
**Requirements**
- [.NET 6.0 SDK](https://dotnet.microsoft.com/download/dotnet/6.0) or later (also compatible with .NET 10)
...
| Key | Action |
|-----|--------|
| ← → | Move cursor left / right within a row |
| ↑ ↓ | Move cursor between top and bottom rows |
| Enter | Select pile / confirm move |
